...
import type { ReadinessQuestion, ProgramMatchProgress } from '@/lib/program-match/types';
import { useDebounce } from '@/lib/hooks/useDebounce';
import { trackReadinessStarted, trackQuestionAnswered, trackProgressSaved, trackReadinessCompleted } from '@/lib/program-match/events';
...
export function ReadinessAssessment({
  ...
  useEffect(() => {
    if (leadId && programId && !hasTrackedStart && questions.length > 0) {
  ...
  }, [leadId, programId, hasTrackedStart, questions.length, quizId, versionId]);
    ...
    <div className="w-full max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-sm border">
      ...
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">
          Readiness Assessment: {programName}
        </h2>
        <p className="text-gray-600">
          Let's assess your readiness for this program. This will help us recommend the best preparation path for you.
        </p>
      </div>
      ...
      <div className="mb-6">
        ...
        {(currentQuestion.type === 'slider' || currentQuestion.type === 'confidence') && (

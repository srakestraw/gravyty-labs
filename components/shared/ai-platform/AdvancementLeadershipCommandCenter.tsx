...
export function AdvancementLeadershipCommandCenter() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        {trendData && trendChartData.length > 0 && !isLoadingTrend && (
          <div className="mt-4 pt-4 border-t border-gray-200">
            <p className="text-xs text-gray-500 mb-2">Trend (last 14 days)</p>
      ...
      {/* 2. Key Risks & Opportunities (Advancement-Owned, Forecast-Impact Focused) */}
      <div className="bg-white border border-gray-200 rounded-lg p-6">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <p className="text-sm text-gray-600 mb-3">
          The following signals reflect upstream demand and are provided for context only. These are not within Advancement's direct control.
        </p>

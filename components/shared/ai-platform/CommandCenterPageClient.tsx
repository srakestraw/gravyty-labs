...
const personaConfigs: Record<Persona, PersonaConfig> = {
  ...
  registrar: {
    label: 'Registrar',
    description:
      'Focus on registration health, data integrity, compliance, and keeping students on track for graduation.',
    descriptionBullets: [
    ...
    recommendedTemplates: [
      {
        ...
        name: 'Registration Blocker Assistant',
        description:
          'Automatically detect and summarize students blocked from registration, with recommended fixes and outreach.',
      },
      {
        id: 'data-integrity-assistant',
        name: 'Data Integrity Assistant',
        description:
          'Monitor student records and course data for duplicates, missing fields, and policy violations.',
      },
      {
        id: 'graduation-path-assistant',
        name: 'Graduation Path Assistant',
        description:
          'Identify students at risk of delayed graduation and coordinate next steps with advisors.',
      },
      {
        id: 'schedule-health-assistant',
        name: 'Schedule Health Assistant',
        description:
          'Flag over- and under-enrolled sections and room capacity issues before registration rush.',
      },
    ],
    recentActivity: [
      {
    ...
    gamePlanTasks: [
      ...
      },
      {
        ...
        impactHint: 'Accurate records reduce audit risk and prevent downstream student issues.',
        type: 'other',
      },
      {
      ...
      },
      {
        ...
        impactHint: 'Catching these early avoids last-minute crises for students and faculty.',
        type: 'retention',
      },
      {
    ...
    flaggedRisks: [
      ...
      },
      {
        ...
        detail:
          'Over-enrolled and under-enrolled sections may lead to cancellation or waitlist issues.',
        severity: 'medium',
      },
    ],
    recentWins: [
  ...
  'student-success': {
    ...
    description:
      'Focus on helping students persist, stay on track academically, and stay engaged through proactive outreach.',
    descriptionBullets: [
    ...
    recommendedTemplates: [
      {
        ...
        name: 'Early Alert Assistant',
        description:
          'Consolidate LMS, attendance, and advisor alerts to identify students at risk and prioritize outreach.',
      },
      {
        id: 'course-performance-assistant',
        name: 'Course Performance Assistant',
        description:
          'Monitor performance and engagement in key courses to highlight trends and flag students needing support.',
      },
      {
        id: 'success-outreach-assistant',
        name: 'Success Outreach Assistant',
        description:
          'Coordinate and log outreach to at-risk students, propose next-best actions, and reduce no-contact rates.',
      },
      {
        id: 'student-success-coach-assistant',
        name: 'Student Success Coach Assistant',
        description:
          'Generate prep briefs, action plans, and follow-up suggestions for upcoming student meetings.',
      },
    ],
    recentActivity: [
      {
    ...
    flaggedRisks: [
      ...
      },
      {
        ...
        detail: 'Intro-level courses driving a disproportionate share of at-risk alerts.',
        severity: 'high',
      },
      {
        id: 'risk-no-contact',
      ...
      },
      {
        ...
        detail: 'Engagement and alert patterns suggest elevated risk of first-year attrition.',
        severity: 'medium',
      },
    ],
    recentWins: [
  ...
  'career-services': {
    ...
    description:
      'Focus on helping students explore careers, secure internships and jobs, and build strong employer relationships.',
    descriptionBullets: [
    ...
    recommendedTemplates: [
      {
        ...
        name: 'Career Engagement Assistant',
        description:
          'Detect students with low or no career activity and recommend targeted nudges or actions.',
      },
      {
        id: 'opportunity-matching-assistant',
        name: 'Opportunity Matching Assistant',
        description:
          'Match students to relevant jobs and internships based on profile, interests, and history.',
      },
      {
        id: 'employer-outreach-assistant',
        name: 'Employer Outreach Assistant',
        description:
          'Monitor employer activity, highlight quiet partners, and suggest outreach to sustain relationships.',
      },
      {
    ...
    gamePlanTasks: [
      {
        ...
        description: 'Students with applications due in the next 7 days or upcoming interviews.',
        impactHint:
      ...
      },
      {
        ...
        description: 'No appointments, event attendance, or applications logged in the last 30 days.',
        impactHint:
      ...
      },
      {
        ...
        impactHint: 'Better-prepared meetings lead to clearer plans and stronger outcomes.',
        type: 'meeting',
      },
      {
        id: 'employer-followup',
        title: 'Follow up with 5 engaged employers with recent student interest',
        description: 'Employers with recent job postings, event participation, or high student views.',
        impactHint: 'Strengthening employer relationships expands opportunities and pipelines.',
        type: 'email',
      },
      {
        id: 'event-promotion',
        ...
        impactHint: 'Targeted promotion boosts event attendance and broadens student exposure to opportunities.',
        type: 'other',
      },
    ],
    flaggedRisks: [
      ...
      },
      {
        ...
        detail: 'Students in these programs show lower application and offer activity.',
        severity: 'medium',
      },
      {
        id: 'risk-employer-churn',
        label: '6 previously active employers are going quiet',
        detail: 'Drop in postings or event participation compared to last term.',
        severity: 'medium',
      },
    ],
    recentWins: [
  ...
  'alumni-engagement': {
    ...
    description:
      'Focus on building lifelong relationships through events, mentoring, volunteering, and meaningful touchpoints.',
    descriptionBullets: [
    ...
    recommendedTemplates: [
      {
        ...
        name: 'Event Promotion Assistant',
        description:
          'Identify the right alumni segments and send targeted nudges to increase RSVPs and attendance.',
      },
      {
        id: 'mentoring-engagement-assistant',
        name: 'Mentoring Engagement Assistant',
        description:
          'Monitor mentoring pairs for inactivity, suggest check-ins, and surface pairs needing support.',
      },
      {
        id: 'volunteer-matching-assistant',
        name: 'Volunteer Matching Assistant',
        description:
          'Match interested alumni to open volunteer roles and recommend personalized invitations.',
      },
      {
        id: 'alumni-reactivation-assistant',
        name: 'Alumni Reactivation Assistant',
        description:
          'Detect lapsed alumni and generate campaigns to bring them back through events, mentoring, or volunteering.',
      },
    ],
    recentActivity: [
      {
    ...
    gamePlanTasks: [
      ...
      },
      {
        ...
        description: 'Pairs with no activity in the last 30 days or unresolved requests for meetings.',
        impactHint:
      ...
      },
      {
        ...
        description: 'Alumni who attended recent events or have indicated interest in giving back.',
        impactHint:
    ...
    flaggedRisks: [
      ...
      },
      {
        ...
        detail: 'Key events are below target registration for the next 2 weeks.',
        severity: 'high',
      },
      {
        id: 'risk-mentoring-dropoff',
        label: '24 mentoring pairs with no activity in 30+ days',
        detail: 'No recent messages, meetings, or check-ins recorded.',
        severity: 'medium',
      },
      {
        id: 'risk-volunteer-coverage',
        label: 'Shortfall in volunteers for upcoming programs',
        detail: "Volunteer needs are not fully covered for next month's initiatives.",
        severity: 'medium',
      },
    ],
    recentWins: [
      ...
      },
      {
        ...
        detail: 'Event Promotion Assistant optimized outreach segments and message timing.',
  ...
  advancement: {
    ...
    descriptionBullets: ['Maintain donor relationships', 'Identify giving opportunities', 'Recover lapsed donors'],
    snapshotMetrics: [
    ...
    dailyFocusSummary: 'Move high-value prospects forward, clear donor replies, and prepare for key meetings.',
    gamification: {
      streakDays: 4,
      weeklyGoal: 8,
      weeklyCompleted: 3,
...
export function CommandCenterPageClient({ context }: { context?: AiPlatformPageContext }) {
  ...
  // Get base path for links - use context if provided, otherwise default to /ai-assistants
  const basePath = getAiPlatformBasePath(context);

  // Determine active segment: only use defaultSegmentId from workspace defaults (ignore URL params)
  // Command Center should remain a workspace overview, not enter task-specific mode
  const activeSegment = useMemo(() => {
    // Only show Active Segment card if there's a workspace default segment
    if (context?.defaults?.defaultSegmentId) {
      return getSegmentById(context.defaults.defaultSegmentId);
    }
    return undefined;
  }, [context]);
  ...
  const workspaceConfig = useMemo(() => {
    if (context?.mode === 'workspace' && context?.workspaceId) {
      try {
        return getWorkspaceConfig(context.workspaceId);
      } catch {
        return undefined;
      }
    }
  ...
  }, [context?.mode, context?.appId, context?.workspaceId, workingMode]);
  ...
  const instanceKeyToPersona: Record<string, Persona> = {
    ...
    'student-lifecycle:financial-aid:operator': 'financial-aid',
    'student-lifecycle:housing:operator': 'housing',
    'career-services:career-services:operator': 'career-services',
    'alumni-engagement:alumni-engagement:operator': 'alumni-engagement',
    'advancement:advancement:operator': 'advancement',
  };

  // Determine if we should show existing content or placeholder (only for workspace mode)
  const shouldShowPlaceholder = instanceKey !== null && !isExistingInstance(instanceKey);
  const effectivePersona = instanceKey ? (instanceKeyToPersona[instanceKey] || 'admissions') : selectedPersona;
  
  // Auto-select persona based on instance key (only for existing instances in workspace mode)
  useEffect(() => {
    if (instanceKey && !shouldShowPlaceholder && effectivePersona !== selectedPersona) {
      setSelectedPersona(effectivePersona);
    }
  }, [instanceKey, shouldShowPlaceholder, effectivePersona, selectedPersona]);
  
  // Mock agent data - in real app, this would come from an API or shared data source
  const allAgents = [
    { id: 'agent-transcript-helper', name: 'Transcript Helper Agent', purpose: 'Clears missing transcripts and sends nudges.' },
    { id: 'agent-registration-requirements', name: 'Registration Requirements Agent', purpose: 'Flags holds and notifies students.' },
  ...
  const recommendedAgents = recommendedAgentIds
    ? allAgents.filter((agent) => recommendedAgentIds.includes(agent.id))
    : [];
  ...
  return (
    <div className="space-y-6">
      ...
      {recommendedAgents.length > 0 && (
        <section key="recommendedAgents" className="rounded-xl border border-gray-100 bg-white p-4 shadow-sm">
          <div className="mb-3">
            <h2 className="text-sm font-semibold text-gray-900">Recommended Agents</h2>
            <p className="text-xs text-gray-500 mt-1">
              Agents recommended for this workspace
            </p>
          </div>
          <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
            {recommendedAgents.map((agent) => (
              ...
              >
                ...
                <span className="text-xs text-gray-600 line-clamp-2">{agent.purpose}</span>
      ...
      {isCoachView ? (
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
          ...
          <div className="space-y-6">
            ...
            {/* Goal Tracker - Available for all personas */}
            {personaGoalConfigs[selectedPersona as PersonaKey] && (
              <PersonaGoalTracker {...personaGoalConfigs[selectedPersona as PersonaKey]} />
            )}
                    ...
                    {persona.flaggedRisks.map((risk) => (
                      <div key={risk.id} className="flex items-start gap-2 text-xs">
                        ...
                        <div className="flex-1">
                          ...
                          {risk.detail && <div className="text-gray-600 mt-0.5">{risk.detail}</div>}
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                {showAssistants && (
                  <div className="space-y-2">
                    {persona.assistants.map((assistant) => (
                      <div key={assistant.id} className="bg-white border border-gray-200 rounded-lg p-3">
        ...
        <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {persona.recentWins.map((win, index) => (
                  <div key={index} className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    {win.detail && <p className="text-sm text-gray-600 mb-3">{win.detail}</p>}
                    {win.assistantName && (
                      <p className="text-xs text-gray-500">
                        Powered by: <span className="font-medium text-gray-700">{win.assistantName}</span>
                      </p>
                    )}
                  </div>
                ))}
          ...
          {persona.assistants.length > 0 && (
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Your {personaLabel} Assistants</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {persona.assistants.map((assistant) => (
                  <div key={assistant.id} className="bg-white border border-gray-200 rounded-lg p-6">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        ...
                        {assistant.impact && <p className="text-xs text-green-700 font-medium">{assistant.impact}</p>}
                      </div>
                      <span
                        className={`px-2 py-1 text-xs font-medium rounded-full flex-shrink-0 ${getStatusColor(
                          assistant.status
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {persona.recommendedTemplates.map((template) => (
            ...
            >
              ...
              {canManage && (
                <Link href={`${basePath}/new?template=${template.id}`}>

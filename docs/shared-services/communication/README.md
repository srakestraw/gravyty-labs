...
**Purpose**: Voice profiles and messaging service.

**Audience**: Engineers

**Scope**: Voice profile management, messaging configuration
...
Communication service manages voice profiles and messaging configuration.

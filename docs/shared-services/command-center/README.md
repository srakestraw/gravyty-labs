...
**Purpose**: Working modes and command center functionality.

**Audience**: Engineers

**Scope**: Working mode management, command center resolver
...
Command Center service manages working modes (operator, leadership, global, workspace).

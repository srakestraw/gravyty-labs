/**
 * Shared fallback logic for Advancement Pipeline generate-mock handler.
 * Used by Netlify functions and can be used by Firebase functions.
 * Returns mock data when OpenAI is not available.
 */

export type ResultType = 'stalled_summary' | 'likely_to_give' | 'priority_list';
...
export function createAdvancementPipelineFallbackMock(
  prompt: string,
  mode?: 'steps' | 'data',
